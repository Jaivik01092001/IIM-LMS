    ...
    const courses = [
      {
        ...
        creator: users[2]._id,
        description:
          "Learn how to create a positive social-emotional climate in schools",
        duration: "4 weeks",
        category: "Education",
      ...
      },
      {
        ...
        requirements: ["Basic understanding of child psychology"],
      ...
      },
      {
        ...
        targetAudience:
          "Aspiring and current school leaders, principals, and administrators",
        isDraft: false,
        status: 1,
      },
      {
        ...
        targetAudience:
          "Teachers, students, and anyone interested in emotional regulation",
        isDraft: false,
        status: 1,
      },
      {
        ...
        targetAudience:
          "K-12 teachers, curriculum developers, and instructional designers",
        isDraft: false,
        status: 1,
      },
    ];
