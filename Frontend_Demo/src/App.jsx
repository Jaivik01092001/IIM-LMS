...
const ProtectedRoute = ({ children, role, permissions }) => {
  ...
  if (role && user.role !== role) {
    ...
    if (
      ...
      // Allow educators or staff with specific permissions to access admin-like routes
      return children;
    }

    // Special case for staff users - they can access admin routes
  ...
  if (permissions && permissions.length > 0) {
    ...
    const userHasPermission = permissionResults.some(
