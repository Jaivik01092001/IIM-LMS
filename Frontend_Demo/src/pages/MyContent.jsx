...
function MyContent() {
  ...
  const [form, setForm] = useState({ title: '', description: '', file: null, type: 'document' });
  ...
  const handleContentClick = (content) => {
    setSelectedContent(selectedContent && selectedContent._id === content._id ? null : content);
  };
      ...
      <div className="bg-white rounded-xl shadow-md p-6 mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500">Manage and share your educational content</p>
          </div>
      ...
      {filteredContent.length === 0 ? (
        <div className="bg-white rounded-xl shadow-md p-8 text-center">
          ...
          <p className="mt-1 text-gray-500">
            {searchTerm ? 'Try adjusting your search or create new content.' : 'You haven\'t created any content yet.'}
          </p>
          {!showForm && (
            <button
                ...
                actions={
                  <div className="space-y-3 w-full">
                    ...
                    >
                      ...
                      {selectedContent && selectedContent._id === item._id ? 'Hide Details' : 'View Details'}
                    </button>
                  </div>
                }
              />
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="mt-1 flex items-center">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${item.status === 'approved' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
